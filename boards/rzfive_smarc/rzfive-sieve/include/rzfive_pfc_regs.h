...
#ifndef __RZFIVE_PFC_REGS_H__
#define __RZFIVE_PFC_REGS_H__

#define	PFC_BASE					(0x11030000)			/* PFC base address */

#define PFC_P06							(PFC_BASE + 0x0006)	/* Port register */
#define PFC_P07							(PFC_BASE + 0x0007)	/* Port register */
#define PFC_P08							(PFC_BASE + 0x0008)	/* Port register */
#define PFC_P09							(PFC_BASE + 0x0009)	/* Port register */
#define PFC_P0A							(PFC_BASE + 0x000A)	/* Port register */
#define PFC_P0B							(PFC_BASE + 0x000B)	/* Port register */
#define PFC_P0C							(PFC_BASE + 0x000C)	/* Port register */
#define PFC_P0D							(PFC_BASE + 0x000D)	/* Port register */
#define PFC_P0E							(PFC_BASE + 0x000E)	/* Port register */
#define PFC_P0F							(PFC_BASE + 0x000F)	/* Port register */
