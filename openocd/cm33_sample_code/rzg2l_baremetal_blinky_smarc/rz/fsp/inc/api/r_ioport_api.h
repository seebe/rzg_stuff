...
#define IOPORT_PRV_PFC_PFC1_OFFSET    (4)
#define IOPORT_PRV_PFC_PFC2_OFFSET    (8)
#define IOPORT_PRV_PFC_PFC3_OFFSET    (12)
#define IOPORT_PRV_PFC_PFC4_OFFSET    (16)
...
typedef enum e_ioport_peripheral
{
	...
	IOPORT_PERIPHERAL_PIN00_MODE0 = (0x0UL),

	/** Pin will function as a Mode1 peripheral pin **/
	IOPORT_PERIPHERAL_PIN00_MODE1 = (0x1UL),

	/** Pin will function as a Mode2 peripheral pin **/
	IOPORT_PERIPHERAL_PIN00_MODE2 = (0x2UL),

	/** Pin will function as a Mode3 peripheral pin **/
	IOPORT_PERIPHERAL_PIN00_MODE3 = (0x3UL),

	/** Pin will function as a Mode4 peripheral pin **/
	IOPORT_PERIPHERAL_PIN00_MODE4 = (0x4UL),

	/** Pin will function as a Mode5 peripheral pin **/
	IOPORT_PERIPHERAL_PIN00_MODE5 = (0x5UL),

	/** Pin will function as a Mode0 peripheral pin **/
	IOPORT_PERIPHERAL_PIN01_MODE0 = (0x0UL << IOPORT_PRV_PFC_PFC1_OFFSET),

	/** Pin will function as a Mode1 peripheral pin **/
	IOPORT_PERIPHERAL_PIN01_MODE1 = (0x1UL << IOPORT_PRV_PFC_PFC1_OFFSET),

	/** Pin will function as a Mode2 peripheral pin **/
	IOPORT_PERIPHERAL_PIN01_MODE2 = (0x2UL << IOPORT_PRV_PFC_PFC1_OFFSET),

	/** Pin will function as a Mode3 peripheral pin **/
	IOPORT_PERIPHERAL_PIN01_MODE3 = (0x3UL << IOPORT_PRV_PFC_PFC1_OFFSET),

	/** Pin will function as a Mode4 peripheral pin **/
	IOPORT_PERIPHERAL_PIN01_MODE4 = (0x4UL << IOPORT_PRV_PFC_PFC1_OFFSET),

	/** Pin will function as a Mode5 peripheral pin **/
	IOPORT_PERIPHERAL_PIN01_MODE5 = (0x5UL << IOPORT_PRV_PFC_PFC1_OFFSET),

	/** Pin will function as a Mode0 peripheral pin **/
	IOPORT_PERIPHERAL_PIN02_MODE0 = (0x0UL << IOPORT_PRV_PFC_PFC2_OFFSET),

	/** Pin will function as a Mode1 peripheral pin **/
	IOPORT_PERIPHERAL_PIN02_MODE1 = (0x1UL << IOPORT_PRV_PFC_PFC2_OFFSET),

	/** Pin will function as a Mode2 peripheral pin **/
	IOPORT_PERIPHERAL_PIN02_MODE2 = (0x2UL << IOPORT_PRV_PFC_PFC2_OFFSET),

	/** Pin will function as a Mode3 peripheral pin **/
	IOPORT_PERIPHERAL_PIN02_MODE3 = (0x3UL << IOPORT_PRV_PFC_PFC2_OFFSET),

	/** Pin will function as a Mode4 peripheral pin **/
	IOPORT_PERIPHERAL_PIN02_MODE4 = (0x4UL << IOPORT_PRV_PFC_PFC2_OFFSET),

	/** Pin will function as a Mode5 peripheral pin **/
	IOPORT_PERIPHERAL_PIN02_MODE5 = (0x5UL << IOPORT_PRV_PFC_PFC2_OFFSET),

	/** Pin will function as a Mode0 peripheral pin **/
	IOPORT_PERIPHERAL_PIN03_MODE0 = (0x0UL << IOPORT_PRV_PFC_PFC3_OFFSET),

	/** Pin will function as a Mode1 peripheral pin **/
	IOPORT_PERIPHERAL_PIN03_MODE1 = (0x1UL << IOPORT_PRV_PFC_PFC3_OFFSET),

	/** Pin will function as a Mode2 peripheral pin **/
	IOPORT_PERIPHERAL_PIN03_MODE2 = (0x2UL << IOPORT_PRV_PFC_PFC3_OFFSET),

	/** Pin will function as a Mode3 peripheral pin **/
	IOPORT_PERIPHERAL_PIN03_MODE3 = (0x3UL << IOPORT_PRV_PFC_PFC3_OFFSET),

	/** Pin will function as a Mode4 peripheral pin **/
	IOPORT_PERIPHERAL_PIN03_MODE4 = (0x4UL << IOPORT_PRV_PFC_PFC3_OFFSET),

	/** Pin will function as a Mode5 peripheral pin **/
	IOPORT_PERIPHERAL_PIN03_MODE5 = (0x5UL << IOPORT_PRV_PFC_PFC3_OFFSET),

	/** Pin will function as a Mode0 peripheral pin **/
	IOPORT_PERIPHERAL_PIN04_MODE0 = (0x0UL << IOPORT_PRV_PFC_PFC4_OFFSET),

	/** Pin will function as a Mode1 peripheral pin **/
	IOPORT_PERIPHERAL_PIN04_MODE1 = (0x1UL << IOPORT_PRV_PFC_PFC4_OFFSET),

	/** Pin will function as a Mode2 peripheral pin **/
	IOPORT_PERIPHERAL_PIN04_MODE2 = (0x2UL << IOPORT_PRV_PFC_PFC4_OFFSET),

	/** Pin will function as a Mode3 peripheral pin **/
	IOPORT_PERIPHERAL_PIN04_MODE3 = (0x3UL << IOPORT_PRV_PFC_PFC4_OFFSET),

	/** Pin will function as a Mode4 peripheral pin **/
	IOPORT_PERIPHERAL_PIN04_MODE4 = (0x4UL << IOPORT_PRV_PFC_PFC4_OFFSET),

	/** Pin will function as a Mode5 peripheral pin **/
	IOPORT_PERIPHERAL_PIN04_MODE5 = (0x5UL << IOPORT_PRV_PFC_PFC4_OFFSET),
#endif
	/** Pin will function as a Mode0 peripheral pin **/
...
typedef enum e_ioport_cfg_options
{
	...
	IOPORT_CFG_PORT_DIRECTION_OUTPUT_WITH_INPUT_ENABLE = 0x0000000C, ///< Sets the pin direction to output (input enable)
